...
\begin{frame}
 ...
 \begin{itemize}
  ...
  in a probability sense. Using condition probability, $\mathbb{E}\mathcal{E}(\hat{f}_{m,n})$ is close to $\mathbb{E}\mathcal{E}(\hat{f}_{D,n})$.
  ...
  \begin{equation}
   \inf_{f_n}\sup_{P_{XY}}\mathbb{E}[\mathcal{E}(f_n)] \geq \varepsilon_1(n) > \varepsilon_2(n)
  \end{equation}
